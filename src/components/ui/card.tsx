...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-border/40 bg-card/60 backdrop-blur-xl text-card-foreground shadow-xl shadow-black/10 overflow-hidden transition-all duration-300",
      className
    )}
    {...props}
  />
